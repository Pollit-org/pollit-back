...
create table "Polls.Projections.GetPollFeedItems"("PollId" uuid, "Title" varchar, "Tags" string[], "CreatedAt" timestamptz, "Options" jsonb, "TotalVotesCount" decimal, "Author" varchar);

create or replace function "Polls.GetPollFeedOfUser"(userId UUID)
